...
compare(prefix=overarm_prefix, tag_list=[tag_1, tag_76, tag_77, tag_78], title="add_transitions")
compare(prefix=underarm_prefix, tag_list=[tag_1, tag_76, tag_77, tag_78], title="add_transitions")

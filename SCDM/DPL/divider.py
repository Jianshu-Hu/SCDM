...
class OneObjCatchDivider(Divider):
    def __init__(self, one_hand_state_dim, one_hand_action_dim):
    ...
    def one_hand_state(self, full_state):
        ...
        # hand2
        hand2_state[:60] = full_state[60:120]
    ...
    def two_hand_action(self, hand1_action, hand2_action):
        ...
        full_action[:20] = hand1_action[:20]
...
class OneObjHandOverDivider(Divider):
    def __init__(self, one_hand_state_dim, one_hand_action_dim):
        super().__init__(one_hand_state_dim, one_hand_action_dim)
        if self.one_hand_state_dim != 68:
            raise ValueError('check state dim')
        if self.one_hand_action_dim != 20:
            raise ValueError('check action dim')
    ...
    def one_hand_state(self, full_state):
        ...
        # hand1
        hand1_state[:48] = full_state[:48]
        hand1_state[48:68] = full_state[96:116]
        # hand2
        hand2_state[:48] = full_state[48:96]
        hand2_state[48:68] = full_state[96:116]
